...
import { LayoutDashboard, Bot, Megaphone, BookOpen, CloudUpload, Pill, X, Shield, FileCheck, UserX, LogOut, Eye } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/medicines-watched', icon: Eye, label: 'Medicines Watched' },
